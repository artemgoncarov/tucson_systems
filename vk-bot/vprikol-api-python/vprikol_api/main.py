...
data = asyncio.run(VprikolAPI(token=TOKEN).get_player_information(server_id=2, nickname="Desmont_Software"))
print(
    f'👤 Информация о игроке {data["playerNick"]} на сервере {data["serverName"]} [{data["playerServer"]}]:\n'
